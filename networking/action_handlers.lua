...
function Client.send(msg)
	-- UPSTREAM CHANGE: Simplified to `if not (msg == "action:keepAliveAck") then`
...
local function action_keep_alive()
	-- UPSTREAM CHANGE: Simplified to `Client.send("action:keepAliveAck")`
...
-- UPSTREAM CHANGE: Removed players parameter and MP.GAME.players setup logic
