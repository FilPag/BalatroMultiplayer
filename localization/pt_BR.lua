...
return {
		...
		Joker = {
			...
			j_mp_lets_go_gambling = {
				...
				text = {
					...
					"ao seu {X:purple,C:white}Rival{} {C:money}$#7#",
				},
			},
			j_mp_speedrun = {
				name = "SPEEDRUN",
			...
			j_mp_penny_pincher = {
				...
				text = {
					"No fim da rodada, ganhe",
					"{C:money}$#1#{} para cada {C:money}$#2#{}",
					"que o seu {X:purple,C:white}Rival{} gastou na última loja",
				},
			},
			j_mp_taxes = {
				name = "Impostos",
				text = {
					"Quando o seu {X:purple,C:white}Rival{} vender",
					"uma carta, este curinga ganha {C:mult}+#1#{} Multi",
			...
			j_mp_pizza = {
				name = "Pizza",
				text = {
					"{C:red}+#1#{} Descarte(s) para todos os jogadores",
					"{C:red}-#2#{} Descarte(s) quando qualquer jogador",
					"seleciona um blind",
					"Comida quando o seu {X:purple,C:white}Rival{} ignora um blind",
				},
			},
			j_mp_pacifist = {
				name = "Pacifista",
	...
	misc = {
		...
		dictionary = {
			...
			k_warning_cheating = "Se você está vendo essa mensagem, seu oponente pode estar trapaceando. Se essa é uma partida ranqueada, por favor mande a mensagem '%s' e depois abra um ticket de suporte em #support",
