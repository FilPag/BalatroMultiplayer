...
return {
	...
	misc = {
		...
		dictionary = {
			...
			k_warning_cheating = "Si vous lisez ceci, il se peut que votre adversaire triche.Si cette partie est classée, envoyez le message '%s' et ouvrez un ticket de support dans #support.",
