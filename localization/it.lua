...
return {
	...
	misc = {
		...
		dictionary = {
			...
			k_warning_cheating = "È probabile che il tuo avversario stia barando. Se questa è una partita classificata per favore invia il messaggio \"%s\" in chat e poi apri un ticket in #support nel server discord",
